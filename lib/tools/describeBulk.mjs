...
export const describeBulk = {
			...
			.array(
				z.object({
					id: z
						.string()
						.describe(
							"The id of the object to describe. This can be a device, channel, state or folder id.",
						),
					desc: z
						.string()
						.describe(
							"The description to set for the object. This will be stored in the common.desc field of the object.",
						),
				}),
			)
	...
	call: (API) => async (args) => {
		const ret = await API.describeBulk(args.items);
		return {
			content: [
				{
					type: "text",
