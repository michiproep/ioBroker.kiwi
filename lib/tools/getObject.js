...
export const getObject = {
    ...
    desc: DESC,
    params: {
        id: z.string().describe("The ID of the object to get. This is usually in the format {instance}.{adapter}.{state} (e.g., 'hue.0.brightness')."),
    },
    call: API => async (args) => {
        let ret = await API.getObject(args)
        return {
            content: [
                {
                    type: "text",
